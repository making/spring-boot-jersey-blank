...
sed -i -e "s/spring-boot-jersey-blank/projectName/g" pom.xml
sed -i -e "s/github\.com\/making\/projectName/github.com\/making\/spring-boot-jersey-blank/g" pom.xml
...
sed -i -e "s/projectName/spring-boot-jersey-blank/g" pom.xml
